...
# gm_attr_est[1, 4] <- list(100 * length(gm_cleaned[is.na(m_consumption_avg_cap)==T | is.na(totalconsumption_monthly)==T]$pair) / length(gm_cleaned$pair))
...
# gm_attr_est[2, 4] <- list(100 * length(gm_cleaned[is.na(hours)==T | is.na(b_hours)==T | is.na(b_hours_miss)==T]$pair) / length(gm_cleaned$pair))
...
# gm_attr_est[3, 4] <- list(100 * nrow(gm_cleaned[is.na(anyworker)==T | is.na(baseanyworker)==T]) / length(gm_cleaned$pair))
...
# gm_attr_est[4, 4] <- list(100 * nrow(gm_cleaned[is.na(m_paidemployees)==T | is.na(base_paidemp)==T]) / length(gm_cleaned$pair))
...
# gm_attr_est[5, 4] <- list(100 * nrow(gm_cleaned[is.na(highrevenue)==T | is.na(b_highrevenue)==T | is.na(miss_baserevenue)==T]) / length(gm_cleaned$pair))
...
# gm_attr_est[6, 4] <- list(100 * nrow(gm_cleaned[is.na(m_rev_cap)==T | is.na(b_revenue)==T | is.na(miss_baserevenue)==T]) / length(gm_cleaned$pair))
...
# gm_attr_est[7, 4] <- list(100 * nrow(gm_cleaned[is.na(highprofits)==T | is.na(b_highprofits)==T | is.na(miss_baseprofits)==T]) / length(gm_cleaned$pair))
